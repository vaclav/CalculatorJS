...
public class Calculator_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_uh00px_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_uh00px_f0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_uh00px_g0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_uh00px_d0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Calculator_Editor.inputFieldListHandler_uh00px_d0(node, "inputField", editorContext);
  ...
  private EditorCell createConstant_uh00px_f0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNodeList_uh00px_g0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Calculator_Editor.outputFieldListHandler_uh00px_g0(node, "outputField", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Vertical(), false);
