...
public class InputField_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_bx1j8e_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_bx1j8e_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createProperty_bx1j8e_a0(EditorContext editorContext, SNode node) {
